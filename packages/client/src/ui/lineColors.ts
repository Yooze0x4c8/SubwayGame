...
export const LINE_NAMES: Record<string, string> = {
  ...
  incheon_1: '인천 1호선', incheon_2: '인천 2호선',
  everline: '용인경전철', uijeongbu: '의정부경전철',
  busan_1: '부산 1호선', busan_2: '부산 2호선', busan_3: '부산 3호선',
  busan_4: '부산 4호선', donghae: '동해선', bgl: '부산김해경전철',
  daegu_1: '대구 1호선', daegu_2: '대구 2호선', daegu_3: '대구 3호선',
  daegyeong: '대경선', daejeon_1: '대전 1호선', gwangju_1: '광주 1호선',
